...
export default class NotifService {
    ...
    localNotif(soundName, message, title, largeIcon = 'ic_launcher', smallIcon = 'ic_notification') {
        this.lastId++;
        PushNotification.localNotification({
            ...
            largeIconUrl: "https://static.thenounproject.com/png/731429-200.png",
    ...
    scheduleNotif(soundName, message, title, largeIcon = 'ic_launcher', smallIcon = 'ic_notification') {
        this.lastId++;
        PushNotification.localNotificationSchedule({
            ...
            ticker: 'My Notification Ticker', // (optional)
            autoCancel: true, // (optional) default: true
            largeIcon: largeIcon, // (optional) default: "ic_launcher"
